...
# User Guide
  ## Compiling the Code
  As fortran is a compiled language, the code must first be compiled before it can be executed. To do so, navigate to the **src** directory within the code and enter the command:
  ```
  make
  ```
  ...
  ```
  ![Profile](https://github.com/ImperialCollegeLondon/ReCoDE_Diffusion_Code/blob/main/FluxProfile.png)
